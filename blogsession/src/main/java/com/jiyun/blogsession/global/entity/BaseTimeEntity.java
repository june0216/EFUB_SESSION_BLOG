package com.jiyun.blogsession.global.entity;
...
public abstract class BaseTimeEntity {
	...
	@Column(updatable = false) // 최초 생성 시간을 기록하는 것이므로 수정할 일이 없다. 따라서 해당 컬럼은 수정되지 않게 막는다.// + 업데이트시 해당 값이 입력이 없는 경우 NULL이 될 수 있는데 update=false를 통해 update 시 NULL값이 들어오는 것을 막을 수 있다.
